...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-login-bg bg-cover bg-center">
      <div className="min-h-screen flex flex-col items-center justify-center bg-black/5 backdrop-blur-sm   opacity-95 p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="relative">
              ...
              <input
                type="text"
                id="username"
                className="w-full bg-transparent border-b border-white text-lg text-white placeholder:text-white/50 pl-12 pr-4 py-2 focus:outline-none focus:border-green-400 transition"
            ...
            <div className="relative">
              ...
              <input
                ...
                id="password"
                className="w-full bg-transparent border-b border-white text-lg text-white placeholder:text-white/50 pl-12 pr-12 py-2 focus:outline-none focus:border-green-400 transition"
            ...
            <div>
              <button
                ...
                className="w-full px-4 py-3 font-bold text-white
                           ...
                           disabled:bg-gray-400/50 disabled:scale-100 disabled:cursor-not-allowed"
                disabled={isLoading}
              >
